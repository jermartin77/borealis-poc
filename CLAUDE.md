...
`src/styles/utilities.css` — manually maintained, global utility classes (e.g., `.ds-scrollbar`). Not generated by Style Dictionary. Import in `src/index.css` if adding new utilities.
